...
DROP USER 'company'@'localhost';
select * from information_schema.tables where table_schema = 'company'; /* should be none */
...
where table_schema = 'company'; -- 0 rows

create database company;
create user 'company'@'localhost' identified by 'company123';
grant all on company.* to 'company'@'localhost';
flush privileges;
show databases; -- company must be visible

-- if you wish to change the password for company:
ALTER USER 'company'@'localhost' 
IDENTIFIED BY 'password'; -- you can create your own password
